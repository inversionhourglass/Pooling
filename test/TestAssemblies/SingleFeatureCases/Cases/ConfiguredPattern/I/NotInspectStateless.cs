...
{
    public class NotInspectStateless : Stateful<NotInspectStateless>
    {
        public static void M()
        {
            ...
            pooling.ShouldPooled(customBoolReset, customObjectReset, customVoidReset);
            pooling.ShouldNotPooled(microsoftItem, statelessItem);
